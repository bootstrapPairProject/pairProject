...
console.log("Wow")
$(`.big${i}`).show()
} else if($(".select-btn").val()=="Uncompleted"){
for (var i = 1 ; i<=idForp ; i ++){
$(`.big${i}`).hide()
} for (var i = 1 ; i<=idForp ; i ++){
...
} else if($(".select-btn").val()=="Completed"){
for (var i = 1 ; i<=idForp ; i ++){
$(`.big${i}`).hide()
} for (var i = 1 ; i<=idForp ; i ++){
...
//add the input in the ul 
// $(".btn-add").on("click",function(){
//     var input = $(".todo-input").val();
//     if(input!==''){
//     console.log(input);
//     var newTodo = $("<li>"+input+"<i class='fas fa-check'><i class='fas fa-trash'></li>");
